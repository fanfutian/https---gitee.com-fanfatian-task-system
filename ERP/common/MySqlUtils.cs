...
namespace ERP
{
    public class BC_MySqlUtils
    {
        ...
        // 连接字符串
        private static string ConnStr = "server=127.0.0.1;user id=root;password=admin123;database=db_task";
        ...
        public static MySqlDataReader ExecuteSQLGetRS(string sql, MySqlConnection conn)
        {
            conn.Open();
            MySqlCommand  command = new MySqlCommand(sql, conn);
